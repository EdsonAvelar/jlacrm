...
<style type="text/css">
	...
	li.separador {
    width: 300px; /* coloque aqui a largura da linha */
...
<img align="center" class="back-img" src="/wp-content/uploads/2021/11/fundo_folha.png"></img>
			...
			<div class="col-md-12">
				...
				<?php 				
					if ($_POST['tipo'] == "imóvel") {
					    ...
					    echo "<img  align=\"right\" class=\"mascote-img\" src=\"/wp-content/uploads/2021/11/maquinario.png\"></img>";
					}elseif ($_POST['tipo'] == "caminhão"){
					    echo "<img  align=\"right\" class=\"mascote-img\" src=\"/wp-content/uploads/2021/11/caminhao.jpg\"></img>";
					}else{
					    echo "";
					}
				?>
				...
				<h4>Entrada: <span style="font-weight: bold;">
					<?php echo $_POST['con-entrada'] ?></span>
				</h4>
				<h4>Parcela: <span style="font-weight: bold;">
					<?php echo $_POST['con-parcelas'] ?></span>
				</h4>
				<h4>Prazo: <span style="font-weight: bold;">
