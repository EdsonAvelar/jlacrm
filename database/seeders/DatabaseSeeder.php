...
class DatabaseSeeder extends Seeder
{
	...
	private function usersTable()
	{
		...
		$user->email = 'administrativo@'.env('APP_DOMAIN');
		$user->status = UserStatus::ativo;
		$user->avatar = 'user-padrao.png';
		...
		$user->email = 'coordenador1@'.env('APP_DOMAIN');
		$user->avatar = 'user-padrao.png';
		...
		$user->email = 'coordenador2@'.env('APP_DOMAIN');
		$user->cargo_id = $cargo_coordenador->id;
		$user->avatar = 'user-padrao.png';
		$user->status = UserStatus::ativo;
		$user->password = Hash::make('123');
		...
		$user = new User();
		$user->name = 'Vendedor1';
		$user->email = 'vendedor1@'.env('APP_DOMAIN');
		$user->avatar = 'user-padrao.png';
		...
		$user = new User();
		$user->name = 'Vendedor2';
		$user->email = 'vendedor2@'.env('APP_DOMAIN');
		$user->avatar = 'user-padrao.png';
		$user->cargo_id = $cargo_vendedor->id;
		$user->status = UserStatus::ativo;
		$user->password = Hash::make('123');
		...
		$user = new User();
		$user->name = 'Vendedor3';
		$user->email = 'vendedor3@'.env('APP_DOMAIN');
		$user->avatar = 'user-padrao.png';
		$user->cargo_id = $cargo_vendedor->id;
		$user->equipe_id = $equipe2->id;
		$user->status = UserStatus::ativo;
		...
		$user = new User();
		$user->name = 'Vendedor4';
		$user->email = 'vendedor4@'.env('APP_DOMAIN');
		$user->avatar = 'user-padrao.png';
		$user->cargo_id = $cargo_vendedor->id;
		$user->equipe_id = $equipe2->id;
		$user->status = UserStatus::ativo;
		...
		$user = new User();
		$user->name = 'Pos Venda';
		$user->email = 'posvenda@'.env('APP_DOMAIN');
		$user->avatar = 'user-padrao.png';
