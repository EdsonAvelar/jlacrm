    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Caluladora - Financiamento</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body left">
                    ...
                    <section class="pb-5 section_financiamento" id="entrySection_1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row financiamento">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-select form-select-lg mb-3 select-amortizacao sac_price"
                                            name="fin-amortizacao[]" aria-label=".form-select-lg example"
                                            id="amortizacao">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input value="" data-mask='R$ #.##0,00' type="text" name="fin-credito[]"
                                            class="form-control money input-auto fin-credito" id="vCredito"
                                            placeholder="Crédito" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row financiamento">
                                    ...
                                    <div class="col-sm-6">
                                        <input value="12%" data-mask="0,0%" type="text" name="fin-juros[]"
                                            class="form-control money input-auto fin-juros" id="finJuros"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="fin-entrada[]"
                                            class="form-control money input-auto fin-entrada" id="vFinEntrada"
                                            placeholder="Entrada" required>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="fin-parcelas[]"
                                            class="form-control input-auto fin-parcelas money" id="vFinParcela"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input value="360" type="text" name="fin-prazo[]"
                                            class="form-control input-auto fin-prazo" id="finPrazo" placeholder="Prazo"
                                            required>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="fin-rendaexigida[]"
                                            class="form-control" id="vFinRendaExigida" placeholder="Valor" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row financiamento" id="itbiDiv">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="fin-cartorio[]"
                                            class="form-control" id="vITBI" placeholder="Valor">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="fin-juros-pagos[]"
                                            class="form-control fakedisabled" id="vFinJuros" placeholder="Valor"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="fin-val-pago-total[]"
                                            class="form-control fakedisabled" id="vFinTotal" placeholder="Valor"
                                            required>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Caluladora - Consórcio</h4>
                            </div>
                        </div>
                    </div>
                    <section class="pb-5 section_consorcio" id="ConSection_1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-credito[]"
                                            class="form-control con-credito money" id="vConCredito" placeholder="Valor"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-adesao[]"
                                            class="form-control con-adesao money" id="vConAdesao" placeholder="Adesão"
                                            required>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Valor Parcela
                                        (Cheia)</label>
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text"
                                            class="form-control con-parcela-cheia money" name="con-parcela-cheia[]"
                                            id="vConParcela" placeholder="Parcela Cheia" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text"
                                            class="form-control con-parcela-reduzida money"
                                            name="con-parcela-reduzida[]" id="vConParcelaReduzida" placeholder=""
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-entrada[]"
                                            class="form-control fakedisabled con-entrada" id="vConEntrada"
                                            placeholder="Entrada" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-select select-items con-parcelas_embutidas"
                                            name="con-parcelas_embutidas[]" id="vConEmbutidas"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-lance[]"
                                            class="form-control money" id="vConLance" placeholder="Lance">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-3 col-form-label">Prazo</label>
                                    <div class="col-sm-6">
                                        <input type="number" name="con-prazo[]"
                                            class="form-control input-auto con-prazo" id="vConPrazo" placeholder="Prazo"
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-rendaexigida[]"
                                            class="form-control fakedisabled" id="vConRendaExigida"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-juros-pagos[]"
                                            class="form-control fakedisabled" id="vConJuros" placeholder="Valor"
                                            required>
                                    </div>
                                        ...
                                        <div id="calcParcRed" hidden>
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" id="calculoReduzido" class="calculoReduzido"
                                                    ...
                                                    data-on="Calculo com Parcela Reduzida"
                                                    data-off="Calculo com Parcela Cheia" data-onstyle="success"
                                                    data-offstyle="warning" checked>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input data-mask='R$ #.##0,00' type="text" name="con-valor-pago[]"
                                            class="form-control fakedisabled" id="vConTotal" placeholder="Valor"
                                            required>
                                    </div>
                                </div>
                    ...
                    <div class="form-group row" id="gerar_proposta" hidden>
                        <div class="col-sm-10">
                            <button type="submit" style="padding: 10px; margin: 20px;"
                                class="btn btn-primary btn-lg">Gerar
                                Proposta</button>
                        </div>
                    </div>
