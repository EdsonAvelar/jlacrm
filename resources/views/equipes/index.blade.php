...
@section('main_content')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control form-control-light" id="edit_nome_lider"
                                    readonly>
                            </div>
    ...
    <form id="target" action="{{ url('equipes/excluir') }}" method="POST">
        ...
        <div class="modal fade" id="deletarEquipe" tabindex="-1" aria-labelledby="deletarEquipeLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
