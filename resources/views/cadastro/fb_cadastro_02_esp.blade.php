      ...
      <div class="row">
        <div class="col-md-12 col-md-push-5">
          <div class="booking-cta center">
            ...
            <h1>Regístrate para Ayudarte a Comprar tu Casa.</h1>
            <p>Después de registrarse, un asesor hablará con usted durante el horario comercial.</p>
            </div>
        </div>
          ...
          <div class="booking-form">
            <form method="POST" action="{{route('cadastrar')}}">
              ...
              <div class="form-group">
                <span class="form-label">*Cual es tu nombre?</span>
                <input class="form-control" type="text" placeholder="Como quer que chamemos você" name="nome" required>
              </div>
              <div class="form-group">
                <span class="form-label">*Cual es el numero de contacto? </span>
              ...
              <div class="form-group">
                <span class="form-label">¿Qué valor de propiedad estás buscando?</span>
              ...
              <div class="form-btn text-center">
                <button class="submit-btn">Solicitar Simulación</button>
              </div>
            </form>
          </div>
        </div>
