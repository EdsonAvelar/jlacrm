...
<div class="card mb-1 mt-1 border1" id={{ $negocio_id }} style="{{ $styles }}">
    <div class="card-body p-3" <?php if (config('card_colorido')=='true' ) { if ($negocio->status == 'ATIVO') {
        if ($last_update < 1) { echo "style='background-color: #ebfaedcc;'" ; } elseif ($last_update < 3) {
            echo "style='background-color: #ffffff;'" ; } elseif ($last_update < 5) {
            echo "style='background-color: #f5f9cc69;'" ; } else { echo "style='background-color: #f8c9c96e;'" ; } }
        ...
        ?>
            ...
            <p class="{{ $mb }}">
                ...
                @else
                <img src="{{ url('') }}/images/sistema/user-padrao.png" alt="user-img"
