<style>
    ...
    @keyframes glowing {
        ...
        30% {
            box-shadow: 0 0 10px 11px rgb(246 248 226 / 70%), 0 0 25px rgba(255, 215, 0, 0.6), 0 0 50px rgba(255, 215, 0, 0.5), 0 0 75px rgba(255, 215, 0, 0.4);
        }

        60% {
            box-shadow: 0 0 10px 16px rgb(255 255 255 / 70%), 0 0 25px rgba(255, 215, 0, 0.6), 0 0 50px rgba(255, 215, 0, 0.5), 0 0 75px rgba(255, 215, 0, 0.4);
        }
