...
<head>
  ...
  <link href="{{url('')}}/feane/css/style.css" rel="stylesheet" />
  <!-- responsive style -->
...
<body>
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="{{url('')}}/feane/images/hero-bg.jpg" alt="">
    </div>
    ...
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="{{url('')}}/feane/images/about-img.png" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="{{url('')}}/feane/images/o1.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Imóvel
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="{{url('')}}/feane/images/o2.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Veiculos
  ...
  <section class="food_section layout_padding-bottom" hidden>
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
          Our Menu
        ...
        <div class="row grid">
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f1.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f2.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Burger
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f3.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f4.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
          ...
          <div class="col-sm-6 col-lg-4 all fries">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f5.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    French Fries
          ...
          <div class="col-sm-6 col-lg-4 all pizza">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f6.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pizza
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f7.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div class="col-sm-6 col-lg-4 all burger">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f8.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Tasty Burger
          ...
          <div class="col-sm-6 col-lg-4 all pasta">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="{{url('')}}/feane/images/f9.png" alt="">
                </div>
                <div class="detail-box">
                  <h5>
                    Delicious Pasta
