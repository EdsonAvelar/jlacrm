        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Gerenciamento de Bordero</h4>
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body left">
                        <h2 class="text-success title">{{ \App\Models\User::find( $vendedor )->name}} </h2>
                        ...
                        <table id="example" class="table w-100 nowrap">
                            ...
                            <tbody>
                                ...
                                @foreach ($bordero_vendedor as $vendedor)

                                <tr>

                                    <td>{{ $vendedor['contrato'] }}</td>
                                    <td>{{ $vendedor['cliente'] }}</td>
                                ...
                                <?php 
                                    $vendas_fechadas = $vendas_fechadas + $vendedor['comissao'] ;
                                    ?>
                                @endforeach
