...
<head>
    <meta charset="utf-8" />
    <title>Log In | {{config('nome')}}</title>
    ...
    <div class="auth-fluid">
                ...
                <div class="card-body">
                    ...
                    <div class="auth-brand text-center text-lg-start">
                        <a href="index.html" class="logo-dark">
                            <span><img src="{{url('')}}/images/empresa/logos/empresa_logo_horizontal.png" alt=""
                                    height="70px"></span>
                        </a>
                        <a href="index.html" class="logo-light">
                            <span><img src="{{url('')}}/images/logos/empresa_logo_horizontal.png" alt=""
                                    height="18"></span>
                        </a>
                    </div>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            <a href="{{route('change-password')}}" class="text-muted float-end"><small>Esqueceu sua
                                    senha?</small></a>
                        ...
                        <div class="d-grid mb-0 text-center">
                            <button class="btn btn-primary" name="submit" value="submit" type="submit"><i
                                    class="mdi mdi-login"></i> Entrar </button>
                        </div>
                        <!-- social-->
        ...
        {{-- <div class="auth-fluid-right text-center">
            <div class="auth-user-testimonial">
                ...
                <p class="lead"><i class="mdi mdi-format-quote-open"></i> Tudo que você precisa em um só lugar! . <i
