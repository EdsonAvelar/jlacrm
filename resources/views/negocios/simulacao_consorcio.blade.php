...
<div id="jumb" class="jumbotron jumbotron-fluid jumb-auto">
    <div class="container">
        <h1 class="display-4" style="color: wheat;">Criador de Propostas - Consórcio</h1>
        <p class="lead" style="color: rgb(255, 255, 255);">Coloque os valores abaixo e clique em Gerar Proposta</p>
    </div>
</div>
    ...
    <form id="form-criar" action="{{ route('negocios.criar_proposta') }}" method="post">
        ...
        {{-- <section>
            ...
            <div class="form-group row financiamento">
                ...
                <div class="col-sm-3">
                    <input value="12%" data-mask="0,0%" type="text" name="fin-entrada"
                        class="form-control money input-auto" id="finJuros" placeholder="Entrada" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input data-mask='R$ #.##0,00' type="text" name="fin-entrada"
                        class="form-control money input-auto" id="vFinEntrada" placeholder="Entrada" required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input data-mask='R$ #.##0,00' type="text" name="fin-parcelas"
                        class="form-control input-auto" id="vFinParcela" placeholder="Parcelas" required>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input value="360" type="text" name="fin-prazo" class="form-control input-auto"
            ...
            <div class="form-group row financiamento" id="itbiDiv">
                ...
                <div class="col-sm-3">
                    <input data-mask='R$ #.##0,00' type="text" name="cartorio" class="form-control"
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input data-mask='R$ #.##0,00' type="text" name="val-pago-total"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="text" name="adminstradora" class="form-control" id="adminstradora" value="ADEMICON"
                    required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input data-mask='R$ #.##0,00' type="text" name="con-adesao" class="form-control"
                    id="vConAdesao" placeholder="Adesão" required>
            </div>
        </div>

        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Parcela até Contemplação</label>
            <div class="col-sm-3">
                <input data-mask='R$ #.##0,00' type="text" class="form-control" id="vConParcelaAte"
                    placeholder="Parcela até Contemplação" required>
            </div>

        </div>

        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Parcela Pós-Contemplação</label>
            <div class="col-sm-3">
                <input data-mask='R$ #.##0,00' type="text" class="form-control" id="vConParcela"
                    placeholder="Parcela Pós-Contemplação" required>
            </div>

        </div>

        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Lance Embutido</label>
            <div class="col-sm-3">
                <input data-mask='R$ #.##0,00' type="text" name="con-lance" class="form-control"
                    id="vLanceEmbutido" placeholder="Lance" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            <label for="inputEmail3" class="col-sm-2 col-form-label">Prazo</label>
            <div class="col-sm-3">
                <input type="text" name="con-prazo" class="form-control input-auto" id="vConPrazo"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input data-mask='R$ #.##0,00' type="text" name="con-rendaexigida"
                    class="form-control fakedisabled" id="vConRendaExigida" placeholder="Renda Exigida" required>
            </div>
        </div>
                ...
                <div id="calcParcRed" hidden>
                    ...
                    <div class="form-check">
                        <input type="checkbox" id="calculoReduzido" class="calculoReduzido" name="cal-reduzido"
                            ...
                            data-off="Calculo com Parcela Cheia" data-onstyle="success" data-offstyle="warning"
                            checked>
                    </div>
                </div>
            </div>
