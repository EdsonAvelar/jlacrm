...
@section('main_content')
    ...
    <div class="container-fluid">
        ...
        <form id="target" action="{{ url('negocios/importar/massivo') }}" method="POST">
                                ...
                                <tbody>
                                    @if (isset($negocios_importados))
                                        @foreach ($negocios_importados as $data)
                                            <tr>
                                                <td><input type="checkbox" name="negocios_importados[]"
                                                        value="{{ $data->id }}" class="select-checkbox"></td>
                                                <td>{{ $data['nome'] }}</td>
                                                <td>{{ $data['telefone'] }}</td>
                                                <td>{{ $data['email'] }}</td>
                                                <td>{{ $data['campanha'] }}</td>
            ...
            <div class="modal fade" id="desativarModal" tabindex="-1" aria-labelledby="desativarModal"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
