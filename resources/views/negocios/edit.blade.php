                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-start mt-3">
                            ...
                            <p class="text-muted mb-2 font-13"><strong>Idade do Negócio:</strong> <span
                                    class="ms-2">Inativo
                                    por x dias</span></p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-start mt-3">
                            ...
                            <p class="text-muted mb-2 font-13"><strong>Cotas :</strong><span
                                    class="ms-2">{{ $negocio->cotas }}</span>
                            </p>
                            <p class="text-muted mb-2 font-13"><strong>Assembleia:</strong><span
                                    class="ms-2">{{ $negocio->assembleia }}</span></p>
                            <p class="text-muted mb-2 font-13"><strong>Crédito :</strong><span
                                    class="ms-2">{{ $negocio->valor }}</span></p>
                            <p class="text-muted mb-2 font-13"><strong>Contrato :</strong><span
                                    class="ms-2">{{ $negocio->contrato }}</span>
                            </p>
                ...
                <div class="card">
                    <div class="card-body">
                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                            ...
                            <li class="nav-item">
                                <a href="#propostas" data-bs-toggle="tab" aria-expanded="false"
                                    class="nav-link rounded-0">
                                    Propostas
                                </a>
                            </li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="levantamento">
                                <form method="POST" action="{{ route('negocio_levantamento') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-select form-control-light" id="dificuldade"
                                                ...
                                                @foreach (DificuldadeTipo::all() as $neg)
                                                    <option value={{ $neg }}
                                                        @if ($levantamento->dificuldade == $neg) {{ 'selected="selected"' }} @endif>
                                                        {{ $neg }}</option>
                                                @endforeach
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="planejamento"
                                                    ...
                                                    @foreach (Planejamento::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->planejamento == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control money" name="parcela_max"
                                                    value={{ $levantamento->parcela_max }}>
                                            </div>
                                        </div>
                                        <div class="col-md-3" id="imovel">
                                            ...
                                            <div class="col-md-12">
                                                <label for="firstname" class="form-label">Possui Valor de
                                                    Entrada</label>
                                                <input type="text" class="form-control money" name="entrada_max"
                                                    value={{ $levantamento->entrada_max }}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="desfazer_bem"
                                                    value={{ $levantamento->desfazer_bem }}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            ...
                                            <div class="col-md-12">
                                                <label for="firstname" class="form-label">Se Mora de Alguel,
                                                    Valor?</label>
                                                <input type="text" class="form-control money" name="aluguel"
                                                    value={{ $levantamento->aluguel }}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="decisores"
                                                    value={{ $levantamento->decisores }}>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control money" name="valor_fgts"
                                                    value={{ $levantamento->valor_fgts }}>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="compor_renda"
                                                    ...
                                                    @foreach (SimNao::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->compor_renda == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="financiamento"
                                                    ...
                                                    @foreach (Produtos::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->financiamento == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="filhos"
                                                    name="filhos">
                                                    <option value="">Selecione um valor</option>
                                                    @foreach (SimNao::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->filhos == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="status_civil"
                                                    ...
                                                    @foreach (EstadoCivil::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->status_civil == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="casa_propria"
                                                    ...
                                                    @foreach (SimNao::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->casa_propria == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3" id="imovel">
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-select form-control-light" id="renda_comprovacao"
                                                    ...
                                                    @foreach (SimNao::all() as $neg)
                                                        <option value={{ $neg }}
                                                            @if ($levantamento->renda_comprovacao == $neg) {{ 'selected="selected"' }} @endif>
                                                            {{ $neg }}</option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="tab-pane show active" id="observacoes">
                                ...
                                <div class="border rounded mt-2 mb-3">
                                    <form action="{{ route('inserir_comentario') }}" class="comment-area-box"
                                        method="POST">
                                        @csrf
                                        <textarea rows="3" class="form-control border-0 resize-none" placeholder="Escreva uma observação...."
                                        ...
                                        <div class="p-2 bg-light d-flex justify-content-between align-items-center">
                                            ...
                                            <input hidden name="user_id" value="{{ \Auth::user()->id }}" />
                                            <button type="submit"
                                                class="btn btn-sm btn-dark waves-effect">Salvar</button>
                                        </div>
                                    </form>
                                </div> <!-- end .border-->
                                <!-- end comment box -->
                                        ...
                                        @foreach ($negocio->atividades->sortByDesc('id') as $atividade)
                                            <div class="timeline-item">
                                                ...
                                                <div class="timeline-item-info">
                                                    ...
                                                    <p class="font-14">{{ $atividade->descricao }} <br><span
                                                            class="ms-0 font-12">{{ $atividade->data_atividade }}</span>
                                                    </p>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="cwebsite"
                                                    ...
                                                    data-mask-reverse="true" data-mask="000.000.000.000.000,00">
                                            </div>
                                        </div> <!-- end col -->
                                    </div> <!-- end row -->
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control"
                                                        value="{{ $negocio->grupo }}" name="grupo">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{ $negocio->contrato }}" name="contrato">
                                                </div>
                                            </div>
                                        </div> <!-- end col -->
                                    </div> <!-- end row -->
