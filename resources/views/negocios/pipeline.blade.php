                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        @foreach ($proprietarios as $proprietario_id => $value)
                                            <a class="dropdown-item" target="_self"
                                                href="{{ route('pipeline_index', ['id' => $curr_funil_id, 'proprietario' => $proprietario_id, 'view_card' => app('request')->view_card, 'status' => 'ativo']) }}">{{ $value }}</a>
                                        @endforeach
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    @foreach ($funils as $funil_id => $value)
                                        <a class="dropdown-item"
                                            href="{{ route('pipeline_index', ['id' => $funil_id]) }}">{{ $value }}</a>
                                    @endforeach
                                </div>
                            </li>
                ...
                <div class="board">
                    ...
                    @foreach ($etapa_funils as $key => $value)
                        ...
                        <div class="tasks">
                            ...
                            @endif
                            <div id="{{ $value }}" class="task-list-items" data="{{ $key }}"
                                data-etapa="{{ $value }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-12">
                                            ...
                                            <input type="text" class="form-control form-control-light"
                                                ...
                                                placeholder="Digite o titulo do negócio" required value=""
                                                maxlength="30">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-12">
                                            ...
                                            <input type="text" class="form-control form-control-light"
                                                id="valor_credito_md" placeholder="Valor do Crédito" name="valor">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="mb-12">
