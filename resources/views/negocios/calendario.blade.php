                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                @foreach ($proprietarios as $proprietario_id => $value)
                                    <a class="dropdown-item" target="_self"
                                        href="{{ route('agendamento.calendario', ['proprietario' => $proprietario_id]) }}">{{ $value }}</a>
                                @endforeach

                                @if (Auth::user()->hasAnyRole(['gerenciar_equipe']))
                                    <a class="dropdown-item" target="_self"
                                        href="{{ route('agendamento.calendario', ['proprietario' => '-2']) }}">Todos</a>
                                @endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" placeholder="Insira Nome do Evento"
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" placeholder="Insira Hora do Evento"
                                                    type="text" name="title" id="event-hour" required="">
                                                <div class="invalid-feedback">Please provide a valid event name</div>
                                            </div>
                                        </div>
                                        <!--div class="col-12">
